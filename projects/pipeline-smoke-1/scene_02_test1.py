...
# Scene Class
class Scene02Test1(VoiceoverScene):
    def construct(self):
        ...
        with self.voiceover(text=SCRIPT["test1"]) as tracker:
            # Title for test scene 1
            title = Text("Test Scene 1", font_size=48, weight=BOLD)
            title.move_to(UP * 3.8)
            play_text_in_slot(self, Write(title), tracker.duration)
