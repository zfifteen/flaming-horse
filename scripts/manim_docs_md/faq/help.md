...
is not already discussed in our [FAQ section](index.html) sufficiently
...
[Code of Conduct](../conduct.html) – in short, be *excellent* to one another:
...
1. Make sure you are running the latest released version of Manim, your problem
   ...
   [Changelog](../changelog.html) for a full list of changes between Manim releases.
