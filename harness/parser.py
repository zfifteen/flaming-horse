...
def parse_build_scenes_response(response_text: str, scene_id: str) -> Optional[str]:
    ...
    required_imports = ["from manim import", "VoiceoverScene", "from narration_script import SCRIPT"]
...
def parse_scene_qc_response(response_text: str) -> Tuple[List[Tuple[str, str]], Optional[str]]:
    """
