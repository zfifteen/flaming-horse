...
# Scene Class
class Scene03Test2(VoiceoverScene):
    def construct(self):
        ...
        with self.voiceover(text=SCRIPT["test2"]) as tracker:
            # Title for test scene 2
            title = Text("Test Scene 2", font_size=48, weight=BOLD)
