...
class Scene02Triangle(VoiceoverScene):
    def construct(self):
        ...
        with self.voiceover(text=SCRIPT["triangle"]) as tracker:
            # SLOT_START:scene_body
            beats = BeatPlan(tracker.duration, [3, 2, 5])

            # Write the scene title
            title = Text("Understanding Right Triangles", font_size=48, weight=BOLD)
