...
[written installation guide](../installation.html) to guide you through the process.
...
If you have followed [our local installation instructions](../installation/uv.html) and
...
your problem. See the [FAQ on getting help](help.html) for instructions.
...
- and if you still run into troubles after that, please reach out to
  us as described in the [Getting Help FAQs](help.html).
