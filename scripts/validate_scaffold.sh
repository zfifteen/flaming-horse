...
check "harness/templates/manim_content_pipeline.md"
check "docs/reference_docs/manim_voiceover.md"
check "harness/templates/manim_template.py.txt"
check "harness/templates/manim_config_guide.md"
echo "══════════════════════════════════════════════════════"
...
if [[ $FAIL -eq 0 ]]; then
  ...
  echo ""
  echo "Next steps:"
  echo "  1. Update template docs with your actual Manim documentation:"
  echo "     cd harness/templates"
