...
versions](faq/installation.html#different-versions) if you are unsure which
version you should install.

1. [(Recommended) Installing Manim via Python’s package manager pip](#local-installation)
2. [Installing Manim to a conda environment](#conda-installation)
3. [Using Manim via Docker](#docker-installation)
4. [Interactive Jupyter notebooks via Binder / Google Colab](#interactive-online)
...
Our [local installation guide](installation/uv.html) provides more detailed
...
- [Conda](installation/conda.html)
  - [Required Dependencies](installation/conda.html#required-dependencies)
  - [Optional Dependencies](installation/conda.html#optional-dependencies)
  - [Working with Manim](installation/conda.html#working-with-manim)
...
- [Docker](installation/docker.html)
  - [Basic usage of the Docker container](installation/docker.html#basic-usage-of-the-docker-container)
  - [Running JupyterLab via Docker](installation/docker.html#running-jupyterlab-via-docker)
...
- [Jupyter Notebooks](installation/jupyter.html)
  - [Binder](installation/jupyter.html#binder)
  - [Google Colaboratory](installation/jupyter.html#google-colaboratory)
...
in our [contribution guide](contributing.html) if you are
interested in that.
