...
Flaming Horse currently uses Chat Completions shape (`/chat/completions`) in `/Users/velocityworks/IdeaProjects/flaming-horse/harness/client.py`.
...
1. Create a new harness implementation under `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses`.
...
4. Add one orchestrator seam for harness selection.
...
`harness_responses` must have zero code dependencies on `/Users/velocityworks/IdeaProjects/flaming-horse/harness`.
...
Add exactly one top-level runtime selection seam (e.g., env flag) to choose harness implementation.
...
2. Default mode for render-critical phases is stateless.
...
1. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/cli.py`
2. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/client.py`
3. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/parser.py`
4. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/prompts/<phase>/system.md`
5. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/prompts/<phase>/user.md`
6. `/Users/velocityworks/IdeaProjects/flaming-horse/harness_responses/templates/*`
7. `/Users/velocityworks/IdeaProjects/flaming-horse/tests/harness_responses/*`
...
1. What exact schema definitions should be used for `plan` and `review` artifacts?
2. Which phases (if any) are allowed to use `web_search` in v1, and under what constraints?
3. What is the default value for Responses storage (`store`) in Flaming Horse policy?
4. What metrics define go/no-go for enabling `harness_responses` as default?
