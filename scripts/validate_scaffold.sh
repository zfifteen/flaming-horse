...
echo "Directories:"
check "docs/reference_docs"
echo ""

echo "Reference Placeholders:"
check "docs/reference_docs/manim_content_pipeline.md"
check "docs/reference_docs/manim_voiceover.md"
check "docs/reference_docs/manim_template.py.txt"
check "docs/reference_docs/manim_config_guide.md"
echo "══════════════════════════════════════════════════════"
...
if [[ $FAIL -eq 0 ]]; then
  ...
  echo ""
  echo "Next steps:"
  echo "  1. Update docs/reference_docs/ with your actual Manim documentation:"
  echo "     cd docs/reference_docs"
