...
You are executing phase: review

Working directory: projects/immune_threshold_hypothesis
...
2. Execute ONLY the review phase tasks as defined in the system prompt above
