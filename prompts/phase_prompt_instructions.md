...
5. For training/narration/build_scenes: update only orchestrator-provided files (e.g., training_ack.md, narration_script.py, target scene file). Use Edit only.
...
6. If an expected phase artifact file is missing (plan.json, training_ack.md, narration_script.py, target scene file), fail the phase and report the missing file in plain text. Do not create it.
